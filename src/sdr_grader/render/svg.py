...
def histogram_chart(your_score: int, median: int, p25: int, p75: int) -> str:
  ...
  <text x="0" y="55" font-family="Söhne, Inter, sans-serif" font-size="9" fill="#8a8a82">0</text>
  <text x="100" y="55" font-family="Söhne, Inter, sans-serif" font-size="9" fill="#8a8a82">25</text>
  <text x="200" y="55" font-family="Söhne, Inter, sans-serif" font-size="9" fill="#8a8a82">50</text>
  <text x="300" y="55" font-family="Söhne, Inter, sans-serif" font-size="9" fill="#8a8a82">75</text>
  <text x="396" y="55" font-family="Söhne, Inter, sans-serif" font-size="9" text-anchor="end" fill="#8a8a82">100</text>
  ...
  <text x="{x(median)}" y="22" font-family="Söhne, Inter, sans-serif" font-size="9" text-anchor="middle" fill="#6b6b66">median {median}</text>
  ...
  <text x="{x(your_score)}" y="14" font-family="Söhne, Inter, sans-serif" font-size="10" font-weight="600" text-anchor="middle" fill="#1a1a1a">you · {your_score}</text>
</svg>'''
