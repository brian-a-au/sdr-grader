...
# "Generated Date & timestamp and timezone" (corpus, 2026-07-17). Mirrors
# the sdr-visualizer originals (SPEC §11/§15).
# ---------------------------------------------------------------------------
...
def test_definition_parser_wraps_json_recursion_error(monkeypatch):
