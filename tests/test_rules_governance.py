"""Tests for registered governance checks."""
...
def test_runtime_history_evidence_overrides_snapshot_metadata():
    implementation = impl(raw={"metadata": {"history_present": True}})
    implementation.history_present = False
