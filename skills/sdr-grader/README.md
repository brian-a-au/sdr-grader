...
The canonical [schema-1 JSON output reference](https://github.com/brian-a-au/sdr-grader/blob/v1.3.0/docs/JSON_OUTPUT.md)
...
[report-sharing privacy matrix](https://github.com/brian-a-au/sdr-grader/blob/v1.3.0/SECURITY.md#report-sharing-privacy-matrix)
