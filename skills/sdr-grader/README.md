...
The canonical [schema-1 JSON output reference](https://github.com/brian-a-au/sdr-grader/blob/v1.2.9/docs/JSON_OUTPUT.md)
...
[report-sharing privacy matrix](https://github.com/brian-a-au/sdr-grader/blob/v1.2.9/SECURITY.md#report-sharing-privacy-matrix)
