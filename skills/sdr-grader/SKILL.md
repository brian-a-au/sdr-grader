...
Use the canonical [schema-1 JSON output reference](https://github.com/brian-a-au/sdr-grader/blob/v1.3.0/docs/JSON_OUTPUT.md)
...
2. Before the first report read, warn: "Selected helper output will enter your
   ...
   operation under the canonical [report-sharing privacy matrix](https://github.com/brian-a-au/sdr-grader/blob/v1.3.0/SECURITY.md#report-sharing-privacy-matrix),
