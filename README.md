...
[![Coverage](https://img.shields.io/badge/coverage-99%25-brightgreen.svg)](https://github.com/brian-a-au/sdr-grader/tree/v1.2.7/tests)
...
[healthy CJA report](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-cja-clean.html),
[diagnostic CJA report](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-cja-messy.html),
or [healthy AA report](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-aa-clean.html).
...
[`src/sdr_grader/core/grade_calc.py`](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/src/sdr_grader/core/grade_calc.py).
...
Download the v1.2.7 synthetic CJA snapshot.

macOS and Linux:

```bash
curl -fL -o cja_snapshot_clean.json https://raw.githubusercontent.com/brian-a-au/sdr-grader/v1.2.7/tests/fixtures/cja_snapshot_clean.json
```

Windows PowerShell:

```powershell
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/brian-a-au/sdr-grader/v1.2.7/tests/fixtures/cja_snapshot_clean.json" -OutFile "cja_snapshot_clean.json"
```
...
[supplementary-input contract](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/SUPPLEMENTARY_INPUTS.md)
...
- **JSON output** at `--json PATH` uses schema `1` and contains stable instance,
  ...
  tagged [JSON output contract](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/JSON_OUTPUT.md).
...
| | Clean (A) | Messy (F) |
|---|---|---|
| **CJA** | [CJA clean](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-cja-clean.html) | [CJA messy](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-cja-messy.html) |
| **AA** | [AA clean](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-aa-clean.html) | [AA messy](https://raw.githack.com/brian-a-au/sdr-grader/v1.2.7/examples/grade-aa-messy.html) |
...
[troubleshooting guide](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/TROUBLESHOOTING.md).
...
- [CI integration](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/CI_INTEGRATION.md) — use `--fail-below` safely in automation.
- [Trend reports](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/TREND_REPORTS.md) — filename conventions and flag interactions.
- [Internal leaderboards](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/LEADERBOARDS.md) — build a distribution reference from collected JSON outputs.
- [Supplementary inputs](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/SUPPLEMENTARY_INPUTS.md) — attach repeatable `--extra-input KEY=PATH` data.
- [Claude Code skill](https://github.com/brian-a-au/sdr-grader/tree/v1.2.7/skills/sdr-grader) — query a grade without rerunning the grader.

## Extending sdr-grader

Start with the tagged
[customization guide](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/CUSTOMIZATION.md),
then choose the narrowest extension surface:

- [Project configuration](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/PROJECT_CONFIG.md) — suppressions in `.sdr-grader.yaml`.
- [Rubric format](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/RUBRIC_FORMAT.md) — fork or create a YAML pack.
- [Check-function guide](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/CHECK_FUNCTION_GUIDE.md) — add rule logic.
- [Adapter guide](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/ADAPTER_GUIDE.md) — add a platform in a source checkout.

## Maintaining sdr-grader

These are source-checkout workflows. Run them from the repository root after
cloning the [v1.2.7 source tree](https://github.com/brian-a-au/sdr-grader/tree/v1.2.7):
...
- [Platform coverage](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/PLATFORM_COVERAGE.md) — CJA/AA compatibility evidence and known gaps.
- [Calibration corpus](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/CALIBRATION_CORPUS.md) — private compatibility and calibration admission.
- [Threshold calibration](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/threshold_calibration.md) — admitted-cohort status.
- [Rubric audit](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/RUBRIC_AUDIT.md) — rule premises against Adobe documentation.
- [Release checklist](https://github.com/brian-a-au/sdr-grader/blob/v1.2.7/docs/RELEASE_CHECKLIST.md) — publication, recovery, and announcement gates.
